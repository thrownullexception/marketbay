					...
					<div class="flex-1 min-w-0">
						...
						<div class="grid grid-cols-2 lg:grid-cols-3 gap-4">
							<StoreProductCard
								...
								image={<CircleIcon class="w-14 h-14 text-brand-200" />}
							...
							<StoreProductCard
								...
								image={<CircleIcon class="w-14 h-14 text-gray-300" />}
							...
							<StoreProductCard
								...
								image={<CircleIcon class="w-14 h-14 text-violet-200" />}
							...
							<StoreProductCard
								...
								image={<CircleIcon class="w-14 h-14 text-emerald-200" />}
