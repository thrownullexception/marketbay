		...
		<>
			<div class="bg-white border-b border-gray-100">
				<div class="max-w-7xl mx-auto px-4 py-2.5">
					<nav class="flex items-center gap-1.5 text-xs text-gray-400">
						<a href="home.html" class="hover:text-brand-600 transition">
							Home
						</a>
						<svg
							class="w-3 h-3"
						...
						<a href="#" class="hover:text-brand-600 transition">
							Stores
						</a>
						<svg
							class="w-3 h-3"
						...
						<span class="text-gray-600 font-medium">TechVault</span>
					</nav>
				</div>
			</div>

			<section class="bg-white border-b border-gray-100">
				<div class="relative h-36 sm:h-44 lg:h-52 bg-gradient-to-r from-brand-700 via-brand-800 to-brand-950 overflow-hidden">
				...
				<div class="max-w-7xl mx-auto px-4">
					<div class="relative -mt-10 sm:-mt-12 mb-4">
						<div class="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white text-2xl sm:text-3xl font-bold border-4 border-white shadow-lg">
							TV
						</div>
					</div>
					...
					<div class="flex flex-col sm:flex-row sm:items-start gap-4 pb-6">
						...
						<div class="flex items-center gap-2 flex-shrink-0">
							<button class="px-5 py-2.5 bg-brand-600 hover:bg-brand-700 text-white text-sm font-semibold rounded-xl transition shadow-sm flex items-center gap-2">
								<svg
									class="w-4 h-4"
									fill="none"
									viewBox="0 0 24 24"
			...
			<section class="bg-white border-b border-gray-100">
				<div class="max-w-7xl mx-auto px-4 py-4">
					<a
						href="#"
						class="block rounded-xl bg-gradient-to-r from-brand-600 to-indigo-700 p-5 sm:p-6 relative overflow-hidden group"
					>
						...
						<div class="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
							...
							<span class="inline-flex items-center gap-1.5 px-5 py-2.5 bg-white text-brand-700 font-semibold rounded-lg text-sm group-hover:bg-brand-50 transition shadow-sm self-start sm:self-center flex-shrink-0">
								Shop Sale{" "}
								<svg
									class="w-4 h-4"
									fill="none"
			...
			<div class="bg-white border-b border-gray-100 sticky top-[57px] z-40">
				<div class="max-w-7xl mx-auto px-4">
					<div class="flex items-center gap-6 overflow-x-auto scrollbar-hide">
						<button class="tab-active whitespace-nowrap py-3 text-sm font-semibold border-b-2 transition">
							All Products
						</button>
						<button class="whitespace-nowrap py-3 text-sm font-medium text-gray-400 border-b-2 border-transparent hover:text-gray-600 transition">
							On Sale
						</button>
						<button class="whitespace-nowrap py-3 text-sm font-medium text-gray-400 border-b-2 border-transparent hover:text-gray-600 transition">
							New Arrivals
								...
								<div class="space-y-2 text-sm">
									...
									<label class="flex items-center gap-2 cursor-pointer">
										<input
											...
											class="rounded border-gray-300 text-brand-600 focus:ring-brand-500"
										/>
										<span class="text-gray-600">$100 – $300</span>
									</label>
									<label class="flex items-center gap-2 cursor-pointer">
										<input
											type="checkbox"
											class="rounded border-gray-300 text-brand-600 focus:ring-brand-500"
										/>
										<span class="text-gray-600">Over $300</span>
									</label>
								</div>
							</div>
          ...
          <div class="product-card bg-white rounded-2xl border border-gray-100 overflow-hidden transition-all duration-300 cursor-pointer">
            <div class="relative aspect-square bg-gray-50">
              <div class="absolute inset-0 bg-gradient-to-br from-slate-50 to-gray-100 flex items-center justify-center">
                <svg class="w-14 h-14 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1"><path stroke-linecap="round" stroke-linejoin="round" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
              </div>
              <span class="absolute top-2 left-2 px-2 py-0.5 bg-red-500 text-white text-[10px] font-bold rounded-md uppercase">-25%</span>
              <button class="absolute top-2 right-2 p-1.5 bg-white/80 backdrop-blur rounded-full hover:bg-white transition shadow-sm"><svg class="w-4 h-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg></button>
            </div>
            <div class="p-4">
              <h3 class="text-sm font-semibold text-gray-900 line-clamp-2">Ultra HD 27" Monitor — 4K IPS Display</h3>
              <div class="flex items-center gap-1 mt-1.5">
              ...
              <div class="flex items-center justify-between mt-3">
                <div><span class="text-lg font-bold text-gray-900">$299</span><span class="text-sm text-gray-400 line-through ml-1">$399</span></div>
                <button class="p-2 bg-brand-600 hover:bg-brand-700 text-white rounded-xl transition"><svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/></svg></button>
              </div>
            </div>
          </div>
          ...
          <div class="product-card bg-white rounded-2xl border border-gray-100 overflow-hidden transition-all duration-300 cursor-pointer">
            <div class="relative aspect-square bg-gray-50">
              <div class="absolute inset-0 bg-gradient-to-br from-violet-50 to-purple-100 flex items-center justify-center">
                <svg class="w-14 h-14 text-violet-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1"><path stroke-linecap="round" stroke-linejoin="round" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>
              </div>
              <span class="absolute top-2 left-2 px-2 py-0.5 bg-brand-600 text-white text-[10px] font-bold rounded-md uppercase">New</span>
              <button class="absolute top-2 right-2 p-1.5 bg-white/80 backdrop-blur rounded-full hover:bg-white transition shadow-sm"><svg class="w-4 h-4 text-rose-500" fill="currentColor" viewBox="0 0 24 24"><path d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg></button>
            </div>
            <div class="p-4">
              <h3 class="text-sm font-semibold text-gray-900 line-clamp-2">MagSafe Case — Frosted Matte Finish</h3>
              <div class="flex items-center gap-1 mt-1.5">
                <svg class="w-3.5 h-3.5 text-accent-500" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                <span class="text-xs text-gray-500">4.8 (890)</span>
              </div>
              <div class="flex items-center justify-between mt-3">
          ...
          <div class="product-card bg-white rounded-2xl border border-gray-100 overflow-hidden transition-all duration-300 cursor-pointer">
            <div class="relative aspect-square bg-gray-50">
              <div class="absolute inset-0 bg-gradient-to-br from-cyan-50 to-sky-100 flex items-center justify-center">
                <svg class="w-14 h-14 text-cyan-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5M9 11.25v1.5M12 9v3.75m3-6v6"/></svg>
              </div>
              <button class="absolute top-2 right-2 p-1.5 bg-white/80 backdrop-blur rounded-full hover:bg-white transition shadow-sm"><svg class="w-4 h-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg></button>
            </div>
            <div class="p-4">
              <h3 class="text-sm font-semibold text-gray-900 line-clamp-2">Mechanical Keyboard — Cherry MX Brown</h3>
              <div class="flex items-center gap-1 mt-1.5">
                <svg class="w-3.5 h-3.5 text-accent-500" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                <span class="text-xs text-gray-500">4.7 (312)</span>
              </div>
              <div class="flex items-center justify-between mt-3">
          ...
          <div class="product-card bg-white rounded-2xl border border-gray-100 overflow-hidden transition-all duration-300 cursor-pointer">
            <div class="relative aspect-square bg-gray-50">
              <div class="absolute inset-0 bg-gradient-to-br from-amber-50 to-orange-100 flex items-center justify-center">
                <svg class="w-14 h-14 text-amber-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1"><path stroke-linecap="round" stroke-linejoin="round" d="M12 18h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>
              </div>
              <span class="absolute top-2 left-2 px-2 py-0.5 bg-red-500 text-white text-[10px] font-bold rounded-md uppercase">-15%</span>
              <button class="absolute top-2 right-2 p-1.5 bg-white/80 backdrop-blur rounded-full hover:bg-white transition shadow-sm"><svg class="w-4 h-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg></button>
            </div>
            <div class="p-4">
              <h3 class="text-sm font-semibold text-gray-900 line-clamp-2">Tablet Stand — Adjustable Aluminum</h3>
              <div class="flex items-center gap-1 mt-1.5">
                <svg class="w-3.5 h-3.5 text-accent-500" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                <span class="text-xs text-gray-500">4.6 (76)</span>
              </div>
              <div class="flex items-center justify-between mt-3">
                <div><span class="text-lg font-bold text-gray-900">$33.99</span><span class="text-sm text-gray-400 line-through ml-1">$39.99</span></div>
                <button class="p-2 bg-brand-600 hover:bg-brand-700 text-white rounded-xl transition"><svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/></svg></button>
              </div>
            </div>
          </div>
          ...
          <div class="product-card bg-white rounded-2xl border border-gray-100 overflow-hidden transition-all duration-300 cursor-pointer">
            <div class="relative aspect-square bg-gray-50">
              <div class="absolute inset-0 bg-gradient-to-br from-emerald-50 to-teal-100 flex items-center justify-center">
                <svg class="w-14 h-14 text-emerald-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1"><path stroke-linecap="round" stroke-linejoin="round" d="M21 7.5l-2.25-1.313M21 7.5v2.25m0-2.25l-2.25 1.313M3 7.5l2.25-1.313M3 7.5l2.25 1.313M3 7.5v2.25m9 3l2.25-1.313M12 12.75l-2.25-1.313M12 12.75V15m0 6.75l2.25-1.313M12 21.75V19.5m0 2.25l-2.25-1.313m0-16.875L12 2.25l2.25 1.313M21 14.25v2.25l-2.25 1.313m-13.5 0L3 16.5v-2.25"/></svg>
              </div>
              <button class="absolute top-2 right-2 p-1.5 bg-white/80 backdrop-blur rounded-full hover:bg-white transition shadow-sm"><svg class="w-4 h-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg></button>
            </div>
            <div class="p-4">
              <h3 class="text-sm font-semibold text-gray-900 line-clamp-2">Portable Bluetooth Speaker — Waterproof</h3>
              <div class="flex items-center gap-1 mt-1.5">
                <svg class="w-3.5 h-3.5 text-accent-500" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                <span class="text-xs text-gray-500">4.8 (456)</span>
              </div>
              <div class="flex items-center justify-between mt-3">
			...
			<section class="border-t border-gray-100 bg-white py-10">
				<div class="max-w-7xl mx-auto px-4">
					...
					<div class="flex flex-col lg:flex-row gap-8 mb-8">
						<div class="flex items-center gap-6 bg-gray-50 rounded-2xl p-6 lg:w-72 flex-shrink-0">
						...
						<div class="flex-1 grid sm:grid-cols-2 gap-4">
							<div class="bg-gray-50 rounded-xl p-5">
								...
								<p class="text-sm text-gray-600 leading-relaxed">
									Incredible quality headphones for the price. Noise
									cancellation is top-notch and the build quality feels premium.
									Shipped fast, well packaged. Will buy again!
								</p>
								<p class="text-xs text-gray-400 mt-2">
									Purchased: Pro Studio Wireless Headphones
								</p>
							</div>
							<div class="bg-gray-50 rounded-xl p-5">
								<div class="flex items-center gap-3 mb-3">
								...
								<p class="text-sm text-gray-600 leading-relaxed">
									The 4K monitor is stunning — colors are accurate and the IPS
									panel is gorgeous. Chat with the seller was super helpful,
									they recommended the right cable adapter too. A+
								</p>
								<p class="text-xs text-gray-400 mt-2">
									Purchased: Ultra HD 27" Monitor
								</p>
							</div>
						</div>
					</div>
