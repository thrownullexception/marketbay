			...
			<Container>
				<Grid3>
					<Link
						...
						search={{ deals: true }}
						class="lg:col-span-2 relative rounded-2xl overflow-hidden bg-linear-to-r from-brand-700 to-brand-900 min-h-[220px] lg:min-h-[280px] flex items-center group"
					>
						...
						<div class="relative px-8 lg:px-10 py-8 w-full">
							...
							<div class="inline-flex items-center gap-1.5 mt-5 px-5 py-2.5 bg-white text-brand-700 font-semibold rounded-lg text-sm hover:bg-brand-50 transition shadow-sm group-hover:shadow-md">
								Shop Deals <ArrowRightIcon class="w-4 h-4" />
							</div>
						</div>
