...
export const LogoHeader = (props: { class?: string }) => (
	<Link to="/" class={`shrink-0 flex items-center gap-2 ${props.class ?? ""}`}>
...
export const LogoFooter = (props: { class?: string }) => (
	<Link to="/" class={`flex items-center gap-2 ${props.class ?? ""}`}>
