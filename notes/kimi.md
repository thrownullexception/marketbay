...
tax_id VARCHAR(50),
verification_level INT DEFAULT 0 CHECK (verification_level IN (0, 1, 2, 3)),
...
bank_account JSONB, -- encrypted: {account_number, routing_number, account_name}
...
cost_per_item DECIMAL(10,2), -- for margin calculation
...
participant_type TEXT, -- 'buyer' or 'seller'
store_id UUID,
...
Table
Copy
Elements Email/phone input, Password input (with show/hide toggle), "Forgot password?" link, "Sign in" button, "Sign in with Google/Apple/Facebook" buttons, "Create account" link, "Stay signed in" checkbox
Actions Click sign in → Authenticate, Click social → OAuth flow, Click forgot → Password reset
Page: Register (Buyer)
Table
Copy
Elements Email input, Password input (with strength meter), Confirm password, "Create account" button, Social signup options, "Already have account? Sign in" link, Terms acceptance checkbox, CAPTCHA
Actions Submit → Email verification sent
Page: Email Verification
Table
Copy
Elements "Verify your email" header, Resend email button, "I verified" check button, Change email link
Actions Click resend → New email sent, Click verified → Check status
...
Bottom Sheet Slide-up panel for filters, actions, confirmations
Pull-to-Refresh Swipe down gesture to reload content
Swipe Actions Left/right swipe on list items for quick actions (delete, archive)
Floating Action Button (FAB) Primary action button fixed bottom-right
Tab Bar Persistent bottom navigation (Home, Search, Cart, Account)
Mobile Header Condensed header with back button, title, minimal actions
Touch-Friendly Targets Minimum 44px touch targets, spacing between buttons
...
├─────────────────────────────────────────────────────────────────────────────┤
│ │
│ NEW FROM STORES YOU FOLLOW [See All >] │
│ ───────────────────────────────────────────────────────────────────── │
│ │
│ ┌──────────┐ ┌──────────┐ ┌──────────┐ ┌──────────┐ ┌──────────┐ │
│ │ [IMG] │ │ [IMG] │ │ [IMG] │ │ [IMG] │ │ [IMG] │ │
...
│ │ $29.99   │  │ $45.00   │  │ $12.99   │  │ $89.99   │  │ $34.50   │     │
│  │ ✓ StoreA │  │ ✓ StoreB │  │ ✓ StoreC │  │ ✓ StoreA │  │ ✓ StoreD │     │
│  └──────────┘  └──────────┘  └──────────┘  └──────────┘  └──────────┘     │
│   (180px × 240px cards, 16px gap, horizontal scroll on mobile)              │
│                                                                             │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
...
│  └──────────┘  └──────────┘  └──────────┘  └──────────┘                    │
│                                                                             │
│  (Grid: 4 columns desktop, 2 tablet, 1 mobile. 280px min card width)        │
...
│  │ ⭐ 4.9 · Verified│  ⭐ 4.7 · Verified│  ⭐ 4.8 · Verified│  ⭐ 5.0 · Verified│
│  │ [+ Follow] │  │ [+ Follow] │  │ [Following]│  │ [+ Follow] │            │
│  └────────────┘  └────────────┘  └────────────┘  └────────────┘            │
│   (Circular logo 80px, card 160px wide, centered content)                   │
│                                                                             │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
...
│  ─────────────────────────────────────────────────────────────────────      │
│                                                                             │
│  [Horizontal product scroll with countdown timer badge on each card]        │
│  [Progress bar showing "78% claimed" on each product]                       │
│                                                                             │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
...
Category pills: Horizontal scroll with snap points, sticky on scroll (mobile)
Quick Add: Click → Toast confirmation "Added to cart" without page change
Follow button: Toggle state immediately, sync in background
Pull-to-refresh on mobile reloads all sections
1.2 PRODUCT DETAIL PAGE
plain
Copy
┌─────────────────────────────────────────────────────────────────────────────┐
│  [←]  Product Name...                    [Share] [♡ Save] [🛒]             │  ← Sticky header on scroll (mobile)
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
│  │                                                                     │   │
│  │                          [MAIN IMAGE]                               │   │
│  │                    (Zoom on hover / pinch mobile)                   │   │
│  │                                                                     │   │
│  │  [←]                                            [→]                 │   │
│  │                                                                     │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
│                              (500px height, light gray bg #f5f5f5)          │
│                                                                             │
│  ┌─────┐ ┌─────┐ ┌─────┐ ┌─────┐ ┌─────┐ [+5 more]  [▶ Video]            │
│  │ IMG │ │ IMG │ │ IMG │ │ IMG │ │ IMG │                                   │
│  └─────┘ └─────┘ └─────┘ └─────┘ └─────┘                                   │
│  (Thumbnail strip, 80px × 80px, first one active border: 2px solid #000)    │
│                                                                             │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  Handmade Ceramic Vase - Minimalist Home Decor                             │
│  ─────────────────────────────────────────────────────────────────────      │
│                                                                             │
│  Sold by: [Logo] Artisan Home Co. ✓ Verified ⭐ 4.9 · 1.2k sales           │
│  [Visit Store >]                                                            │
│                                                                             │
│  $45.00  ~~$60.00~~  Save 25%                                              │
│  or 4 interest-free payments of $11.25 with Klarna                         │
│                                                                             │
│  ⭐⭐⭐⭐⭐ 4.8 (234 reviews)  [Write a review]                              │
│                                                                             │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  COLOR: Blue                                                                │
...
│  │ 🔵 │ │ ⚪ │ │ 🟢 │ │ 🟤 │                                               │
│  └────┘ └────┘ └────┘ └────┘                                               │
│  (Selected: 2px ring, hover: scale 1.1)                                     │
│                                                                             │
...
│                                                                             │
│  [ 💬 Chat with Seller ]  [ ❤️ Save to Wishlist ]                          │
│                                                                             │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  📍 Deliver to 10001                                                        │
...
│                                                                             │
│  ✓ FREE delivery by Thursday, Feb 20                                        │
...
│  DESCRIPTION                                    [▼]                         │
│  ─────────────────────────────────────────────────────────────────────      │
│  Elevate your space with this handcrafted ceramic vase...                   │
...
│  ─────────────────────────────────────────────────────────────────────      │
│  ┌────────┐  Artisan Home Co. ✓                                             │
│  │ [LOGO] │  ⭐ 4.9 · 12.3k followers · 99% response rate                   │
│  │        │  "Handmade ceramics for modern homes"                           │
│  └────────┘                                                                 │
│                                                                             │
│  [Visit Store]  [+ Follow]  [💬 Chat]                                       │
│                                                                             │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  REVIEWS (234)                                [▼]                           │
...
│  ─────────────────────────────────────────────────────────────────────      │
│  ┌────────┐                                                                 │
│  │ [IMG]  │  ⭐⭐⭐⭐⭐  "Absolutely beautiful!"                             │
│  │ [IMG]  │  Verified Purchase · 2 days ago                                │
│  │ [IMG]  │  Sarah M.                                                      │
│  └────────┘  The quality exceeded my expectations. Packaging was...         │
│              [Helpful (12)]  [Report]                                       │
│                                                                             │
│  [See all 234 reviews]                                                      │
│                                                                             │
...
│  Home   Search  Categ.   Cart   Account                                     │
│  (Cart shows $45.00 subtotal when item added)                               │
└─────────────────────────────────────────────────────────────────────────────┘
Key Interactions:
Image gallery: Swipe on mobile, arrow keys on desktop, thumbnail click to navigate
Variant selection: Updates main image, price, and availability in real-time
Add to Cart: Button transforms to "Added ✓" for 2s, cart icon updates with animation
Sticky bar (mobile): Appears after scrolling past image, shows price + Add to Cart
Accordion sections: Expand/collapse with smooth animation, one open at a time
1.3 SHOPPING CART PAGE
plain
Copy
┌─────────────────────────────────────────────────────────────────────────────┐
│  [←]  Shopping Cart (3 items)                          [💬 Support]         │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
...
│                                                                             │
│  ─────────────────────────────────────────────────────────────────────────  │
│  FROM: Artisan Home Co. ✓  [💬 Message Seller]                             │
│  ─────────────────────────────────────────────────────────────────────────  │
│                                                                             │
│  ┌────────┐                                                                 │
...
│  ─────────────────────────────────────────────────────────────────────────  │
│                                                                             │
│  Store subtotal: $77.00                                                     │
│  Shipping: Calculated at checkout                                           │
│  [Add promo code] ▼                                                         │
│                                                                             │
│  ─────────────────────────────────────────────────────────────────────────  │
│  FROM: TechGear Store ✓  [💬 Message Seller]                               │
│  ─────────────────────────────────────────────────────────────────────────  │
│                                                                             │
│  ┌────────┐                                                                 │
...
1.5 STORE PAGE (BUYER VIEW)
plain
Copy
┌─────────────────────────────────────────────────────────────────────────────┐
│  [←]  [Share]  [Search in store]  [♡ Follow]                               │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
│  │                                                                     │   │
...
│  │                                                                     │   │
│  │  ┌──────────┐                                                       │   │
│  │  │          │  Artisan Home Co. ✓ Verified                          │   │
│  │  │  [LOGO]  │  ⭐ 4.9 · 12.3k followers · 99% response rate         │   │
│  │  │          │  "Handmade ceramics & home decor from Portland, OR"   │   │
│  │  └──────────┘                                                       │   │
│  │                                                                     │   │
│  │  [+ Follow]  [💬 Chat]  [About]                                      │   │
│  │                                                                     │   │
...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  [🏠 Home] [🔥 Popular] [🆕 New Arrivals] [💰 Sale] [🎁 Gift Ideas]        │
│  (Category pills, horizontal scroll, sticky on scroll)                      │
│                                                                             │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
...
│  ─────────────────────────────────────────────────────────────────────────  │
│                                                                             │
│  Filter: [All Products ▼] [Sort by: Popular ▼]                              │
│                                                                             │
│  ┌──────────┐ ┌──────────┐ ┌──────────┐ ┌──────────┐                       │
│  │ [IMG]    │ │ [IMG]    │ │ [IMG]    │ │ [IMG]    │                       │
│  │    -20%  │ │          │ │    NEW   │ │          │                       │
...
│  ─────────────────────────────────────────────────────────────────────────  │
│                                                                             │
│  We are a small team of ceramic artists based in Portland...                │
│  [Read more]                                                                │
│                                                                             │
...
│                                                                             │
│  Recent reviews:                                                            │
│  [Review cards with photos, verified badges, seller responses]              │
│                                                                             │
│  [See all reviews]                                                          │
│                                                                             │
├─────────────────────────────────────────────────────────────────────────────┤
...
│  ┌─────────────┐ ┌─────────────┐ ┌─────────────┐ ┌─────────────┐           │
│  │   $1,247    │ │     23      │ │    $54.22   │ │    3.2%     │           │
│  │   Today's   │ │    Orders   │ │     AOV     │ │  Conversion │           │
│  │   Revenue   │ │   (▲ 12%)   │ │   (▲ 5%)    │ │   (▲ 0.4%)  │           │
│  │   (↑ 24%)   │ │             │ │             │ │             │           │
│  └─────────────┘ └─────────────┘ └─────────────┘ └─────────────┘           │
│   (Metric cards, 200px wide, green/red indicators for change)               │
│                                                                             │
│  ┌─────────────────────────────────────┐  ┌─────────────────────────────┐  │
│  │                                     │  │      QUICK ACTIONS          │  │
